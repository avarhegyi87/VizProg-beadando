...
namespace enMetalBands
{
    ...
    public partial class cnMetalBands : DbContext
    {
        ...
        internal virtual DbSet<enUser> enUsers
        {
            get;
            set;
        }
        ...
        private void enMusicianMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enMusician>().Property(x => x.Instrument).HasColumnName(@"instrument").ValueGeneratedNever();
        ...
        private void enUserMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enUser>().Property(x => x.UserId).HasColumnName(@"user_id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<enUser>().Property(x => x.UserName).HasColumnName(@"user_name").IsRequired().ValueGeneratedNever().HasMaxLength(25);
            modelBuilder.Entity<enUser>().Property(x => x.Password).HasColumnName(@"password").IsRequired().ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<enUser>().HasKey(@"UserId");
