...
namespace enMetalBands
{
    ...
    public partial class cnMetalBands : DbContext
    {
        ...
        {
            modelBuilder.Entity<enMetalBand>().HasMany(x => x.Albums).WithOne(op => op.MetalBand).HasForeignKey(@"Band_id").IsRequired(true);
            ...
            modelBuilder.Entity<enAlbum>().HasOne(x => x.MetalBand).WithMany(op => op.Albums).HasForeignKey(@"Band_id").IsRequired(true);
