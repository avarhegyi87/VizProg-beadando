...
namespace enMetalBands
{
    ...
    public partial class cnMetalBands : DbContext
    {
        ...
        internal virtual DbSet<enCredentials> enCredentials
        {
            get;
            set;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.enCredentialsMapping(modelBuilder);
            this.CustomizeenCredentialsMapping(modelBuilder);
        ...
        private void enAlbumMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enAlbum>().Property(x => x.Date_of_release).HasColumnName(@"date_of_release").ValueGeneratedNever();
        ...
        #region enCredentials Mapping

        private void enCredentialsMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<enCredentials>().ToTable(@"Credentials");
            modelBuilder.Entity<enCredentials>().Property(x => x.UserId).HasColumnName(@"user_id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<enCredentials>().Property(x => x.UserName).HasColumnName(@"user_name").IsRequired().ValueGeneratedNever().HasMaxLength(25);
            modelBuilder.Entity<enCredentials>().Property(x => x.Password).HasColumnName(@"password").IsRequired().ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<enCredentials>().HasKey(@"UserId");
            modelBuilder.Entity<enCredentials>().HasIndex(@"UserName").IsUnique(true);
        }

        partial void CustomizeenCredentialsMapping(ModelBuilder modelBuilder);
